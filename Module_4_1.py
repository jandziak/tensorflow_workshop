...
print(int(round(len(x_vals)*0.8)))
...
### Exercise modelue_4_1

#Create new variables with:
#	a) Use L2 distance instead of L1 
#	b) calculate model for k = 2, 4, 6, and 8
#   c) Check for both metrics which k value performs the best (loss is smallest)
#   d) Compare different histograms